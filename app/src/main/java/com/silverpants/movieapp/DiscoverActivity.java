...
public class DiscoverActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        mApplyButton.setOnClickListener((v) -> {
                    ...
                    model.getDiscover(Integer.parseInt(mYearField.getText().toString()), Keys.SORT_BY_VALUES[index]).observe(DiscoverActivity.this, (resultPagedList) -> {
        ...
        movieAdapter.setMovieClickListener((movie_id -> {
            Intent intent = new Intent(DiscoverActivity.this, MovieActivity.class);
